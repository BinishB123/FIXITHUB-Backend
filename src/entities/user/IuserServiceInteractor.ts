...
import { IgetservicesResponse, IRequirementToFetchShops, ProviderShopSelectedServiceFinalData, ResponsegetBookingGreaterThanTodaysDate, responseGetReviewDetails, reviewAddedResponse } from "./IuserResponse";
...
interface IuserServiceInteractor {
    ...
    addReview(data: { review: string, userId: string, providerId: string, serviceId: string, bookingId: string }, result: { url?: string; message?: string }[]): Promise<{ success?: boolean, review?: reviewAddedResponse }>
