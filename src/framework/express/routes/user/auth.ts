...
const userAuthInteractor = new UserAuthInteractor(respository, mailer, jwtServices)
...
userAuthRouter.get('/checker', verification("user"), controller.checker.bind(controller))
