...
providerProfileRoute.get(
    ...
    providerProfileController.getDataToProfile.bind(providerProfileController)
);
providerProfileRoute.patch(
    "/editabout",
    providerProfileController.editAbout.bind(providerProfileController)
);
providerProfileRoute.patch(
    "/addlogo",
    upload.single("files"),
    providerProfileController.addLogo.bind(providerProfileController)
);
providerProfileRoute.patch(
    "/updataprofileData",
    providerProfileController.updateProfile.bind(providerProfileController)
);
providerProfileRoute.get(
    "/getallBrands",
    providerProfileController.getAllBrands.bind(providerProfileController)
);
providerProfileRoute.patch(
    "/changepassword",
    providerProfileController.changePassword.bind(providerProfileController)
);
providerProfileRoute.patch(
    "/changelogo",
    upload.single("files"),
    providerProfileController.updateLogo.bind(providerProfileController)
);
providerProfileRoute.get(
    "/getchatid/:providerId/:userId",
    providerProfileController.getChatId.bind(providerProfileController)
);
providerProfileRoute.get(
    "/getonetonechat/:chatid",
    providerProfileController.getOneToneChat.bind(providerProfileController)
);
providerProfileRoute.get(
...
providerProfileRoute.get(
    "/monthly-revenue/:id",
    providerProfileController.getMonthlyRevenue.bind(providerProfileController)
);
providerProfileRoute.get(
    "/top-booked-Service/:id",
